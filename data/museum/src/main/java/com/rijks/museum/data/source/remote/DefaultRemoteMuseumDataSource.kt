...
class DefaultRemoteMuseumDataSource @Inject constructor(
    ...
    override suspend fun getListOfArts(
        ...
        pageSize: Int,
        lang: String
    ): SealedResult<List<UiArtsObject>, DataError> = wrapThrowable(
        {
    ...
    override suspend fun getArtDetails(artId: String, lang: String): SealedResult<UiArtDetails, DataError> = wrapThrowable(
        {
